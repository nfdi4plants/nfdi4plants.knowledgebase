...
After concluding this quickstart, you might want to explore the [ARC Commander manual](/nfdi4plants.knowledgebase/arc-commander) for a more detailed usage instruction.
