...
<Card icon="pen" title="elab2ARC">
    ...
    5. Click `Start Conversion` to begin the conversion. The converted data will be uploaded directly to the ARC.
    6. In the Conversion Status window, you can observe the LLM Response Stream during the conversion process. Once it is finished, go to `View ARC` to directly check it in the DataHUB.  
