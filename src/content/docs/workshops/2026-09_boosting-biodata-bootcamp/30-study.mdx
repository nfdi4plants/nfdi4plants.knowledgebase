...
import ArcitectGXStudy from "@kb/arcitect-gx/start-here/add-study.mdx"
import ArcitectGXProtocol from "@kb/arcitect-gx/start-here/add-protocol.mdx"

import ArcitectStudy from "@kb/start-here/arcitect/arcitect-add-study.mdx"
import ArcitectProtocol from "@kb/start-here/arcitect/arcitect-add-protocol.mdx"
