...
To simplify the integration of protocols and metadata from ELNs into ARC, DataPLANT has delevoped the tool [elab2ARC](/nfdi4plants.knowledgebase/resources/elab/), which automates the conversion of [eLabFTW](https://www.elabftw.net/) experiments into ARC format. 
