...
Public data repositories are one option to [publish your research data](/fundamentals/data-publications/). They usually focus on the data &ndash; as opposed to other research outputs such as manuscripts. Data repositories assign [persistent identifiers](/fundamentals/persistent-identifiers/) (e.g. a DOI) to your dataset and by that comply with requirements of most publication journals.  
...
[e!DAL-PGP](<https://edal.ipk-gatersleben.de/index.html>) | Plant Genomics & Phenomics Research Data Repository | phenome | <ApproveIcon />
...
----------------|-----------|------------------ 
**[ARC](/core-concepts/arc)**  <br /> (Annotated Research Context) | Standard | **Structure:** <ul><li>Package data with metadata</li></ul>
...
**[ARC Commander](/arc-commander)** | Tool | **Collect, structure and share:** <ul><li>Add bibliographical metadata to your ARC</li><li>ARC version control and sharing via DataPLANT's DataHUB</li><li>Automated metadata referencing and version control as your ARC grows</li></ul>
**[DataHUB](/datahub)** | Service | **Share:** <ul><li>Federated system to share ARCs</li><li>Manage who can view or access your ARC</li></ul>


(/fundamentals/data-publications/): ../fundamentals/DataPublications.html "Data Publication"
[kb-FairDataPrinciples]: ../fundamentals/FairDataPrinciples.html "FAIR Data principles"
[kb-Metadata]: ../fundamentals/Metadata.html "Metadata"
(/fundamentals/persistent-identifiers/): ../fundamentals/PersistentIdentifiers.html "Persistent Identifiers"
(/core-concepts/arc): ../implementation/AnnotatedResearchContext.html "Annotated Research Context"
(/datahub): ../implementation/DataHub.html "DataPLANT DataHUB"

(/datahub/datahub-account): <https://register.nfdi4plants.org/> "DataPLANT Registration"
(/datahub): <https://git.nfdi4plants.org> "DataHUB"
(/core-concepts/arc/#arc-specification): ./../implementation/ARC-specification.html "ARC specification"
[gh-Swate]: <https://github.com/nfdi4plants/Swate/> "GitHub Swate"
(/arc-commander): ../ArcCommanderManual/index.html "ARC Commander Manual"