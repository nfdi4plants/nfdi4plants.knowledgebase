...
description: Data sharing is the key to every successful research project. Learn about the merits of data sharing, the one-stop-shop dilemma, and how DataPLANT supports you in data sharing.
authors:
  - dominik-brilhaus
---
...
----------------|-----------|------------------
**[ARC](/core-concepts/arc)**  <br /> (Annotated Research Context) | Standard | **Structure:** <ul><li>Package data with metadata in a defined format</li></ul>
