...
description: Data publications are an integral part of the open science movement. Learn about the benefits, criteria, and how DataPLANT supports you in data publishing.
authors:
  - martin-kuhl
  - stella-eggels
sidebar:
...
1. Of course, your data needs to be hosted in a repository to make it available for everyone. Various [repositories](/nfdi4plants.knowledgebase/fundamentals/public-data-repositories) exist, which have been developed to support data publication, e.g. [Zenodo](https://zenodo.org/), including general, but also domain-specific data repositories exist.
2. Your dataset needs to be well annotated, allowing other researchers to understand and reuse your data (see also [metadata](/nfdi4plants.knowledgebase/fundamentals/metadata)).
3. Your dataset needs to be assigned a [persistent identifier](/nfdi4plants.knowledgebase/fundamentals/persistent-identifiers/) (PID), such as a DOI. This can be assigned directly on the repository or with the help of a publication service, such as [Invenio](https://inveniosoftware.org/products/rdm/). The identifier will allow others to cite your dataset.
...
The [PLANTdataHUB](/nfdi4plants.knowledgebase/datahub) offers a platform to share and publish your data. After the publication process via invenio, a DOI is assigned to the ARC and it becomes available in the [ARChive](https://archive.nfdi4plants.org/communities/dataplant). For more detailed information on the ARC publication process, check out the [data publications section](https://nfdi4plants.github.io/nfdi4plants.knowledgebase/datahub/data-publications/).
