...
description: A Data Management Plan (DMP) structures the handling of research data in a scientific project and describes how to deal with the data during and after the end of the project.
authors:
  - martin-kuhl
  - stella-eggels
sidebar:
...
A DMP structures the handling of research data in a scientific project and describes how to deal with the data during and after the end of the project. Many third-party funders, such as DFG, Horizon Europe, or BMBF expect you to provide information on the handling of research data as part of your funding application. Not only is a DMP by now mandatory for many funders in plant sciences, it is always beneficial for your work on a research project.

## Advantages of a DMP

A DMP allows you to track the current status of data within your project throughout its entire lifecycle. Thus, it is also helpful for the administration and to keep an overview. Scientific practice shows that you generally profit from the effort spent on better structuring, documentation, and organization of your research data, if you [FAIRify](/nfdi4plants.knowledgebase/fundamentals/fair-data-principles) and thereby, lower the hurdles of reusing your datasets. Additional personnel, technical, or infrastructural resources required for compliance with your DMP can usually be claimed in third-party funding applications. 
Advantages of a DMP include:
...
DataPLANT helps the community by providing [DataPLAN](https://plan.nfdi4plants.org/), a Data Management Plan Generator with various pre-written text blocks. The tool provides guidance throughout the writing process, as it is a living document. When opening the tool, users first need to select the type of document they want to generate. Users can choose between templates of different funders, like DFG, BMBF or Horizon Europe, user-defined templates or a practice guide. Project-specific information is filled in a simple questionnaire. Depending on the template choice, the tool will restructure the document and point out errors when information is missing. The tool also gives the possibility to save the document in different formats during or after completion. For a more detailed article about DataPLAN, you can click [here](/nfdi4plants.knowledgebase/resources/dataplan).

![DMPG](@images/dataplan/dataplan-layout.png)
