...
Default search enables/disables search of the [SwateDB](https://nfdi4plants.github.io/nfdi4plants.knowledgebase/fundamentals/ontology-service-landscape/#swatedb-and-swobup). A DataPLANT maintained ontology database, which features a set of external ontologies, as well as our DPBO broker ontology, allowing us to quickly update and extend the terms offered via this search option.

### TIB Term Search

The TIB database is a optimized for fast search speed and features different collections of ontologies. Through this optimized single access point, users can access different ontologies across a wide range of scientific fields, such as engineering or chemistry. 
