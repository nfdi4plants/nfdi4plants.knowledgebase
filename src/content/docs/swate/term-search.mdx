...
You cann access the ontology term search fields in different ways. You can select the *Building Blocks* and on the *Ontology Term Search* in the <a href={SwateOverview.src} target="_blank">sidebar</a>. Alternatively, you can start typing in a cell of your annotation table and the tearm search opens automatically. In the combobox that is opening, you can click on a term to add it to your annotation table, to insert ontology terms in an [ISA-Tab conform way](https://isa-specs.readthedocs.io/en/latest/isatab.html#ontology-annotations).
...
![Image highlighting ontology term search example](@images/swate/swate-alpha-ontology-term-search-example.png)
...
![Image highlighting important components of the swate in-table term search](@images/swate/swate-alpha-ontology-termsearch4-only-children.png)
...
![Image highlighting important components of the swate in-table term search](@images/swate/swate-alpha-details.png)
You can open the swate term search details modal by clicking F2 on a term in the search. It will show additional information on its information tab.*

![Image highlighting important components of the swate in-table term search](@images/swate/swate-alpha-details-advanced-search.png)
*You can also use the advanced term search for a more refined search approach in the term search details modal. Just click on the magnifying glass with the + icon in the middle of the term search details modal.*

![Image highlighting important components of the swate in-table term search](@images/swate/swate-alpha-ontology-termsearch4-settings.png)
*In addition to the information tab or advanced search tab, you can also access several term setting by clicking on the Termsearch Settings (cog) tab. Several term settings are displayed here, including the Id of its parent.*
