...
## Adapting the Term Search

In the settings you can configure your term search in the "Term Search Configuration" part further. You can decide whether the default term search shall be used or not. Additionally, you can add and remove high performance search TIB terms to optimize your search further.

##### Default Search

By using the default search, users also query the [DPBO](https://nfdi4plants.github.io/nfdi4plants.knowledgebase/fundamentals/ontology-service-landscape/#how-can-i-find-a-certain-ontology-term-for-my-data-annotation), an ontology repository that is quickly updated based on user feedback. That way new terms are often added faster here than in other ontologies and enable the usage of these new term.

##### TIB Terms

The use of [TIB terms](https://terminology.tib.eu/ts/collections?col=DataPLANT) enables high-performance search capabilities. Through this optimized single access point, users can explore ontologies across a wide range of scientific fields besides those provided by DataPlant.
