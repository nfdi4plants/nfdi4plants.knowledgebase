...
*In addition to the information tab or advanced search tab, you can also access several term settings by clicking on the term search settings (cog) tab. Several term settings are displayed here, including the Id of its parent.*
