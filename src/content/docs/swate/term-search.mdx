...
*You can open the Swate term search details modal by clicking F2 on a term in the search. It will show additional information on its information tab. When you have swapped the tab in the modal, you can view the details again by clicking on the <Icons.CreateMetadata /> tab.*

*You can also use the advanced term search for a more refined search approach in the term search details modal. Just click on the <Icons.Terms /> with the in the middle of the term search details modal.*

*In addition to the information tab or advanced search tab, you can also access several term settings by clicking on the <Icons.Settings /> tab. Several term settings are displayed here, including the Id of its parent.*
