...
When you have an empty excel sheet or one hat already contains an annotation table, you can click "Create Annotation Table" (<Icons.CreateAnnotationTable />) in the <a href={SwateOverview.src} target="_blank">Sidebar</a>.
