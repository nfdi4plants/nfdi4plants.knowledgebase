...
You create by clicking "Create Metadata" (<Icons.CreateMetadata />) in the sidebar. When a top level metadatasheet is available, the different properties of it will be loaded, enabling you to manipulate the data outside the sheet itself or delete it.
