...
The import function can be found next to the export function in the side bar. For importing a filled Swate table, select the same format that was used for the export, upload your file and select your desired import options.
