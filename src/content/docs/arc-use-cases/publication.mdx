...
1. Try to find and transfer all info (sample accessions, IDs, metadata, links, etc.) into the ARC. See this use-case for more details on how to do this: [Repository Data Files](/nfdi4plants.knowledgebase/arc-use-cases/repository-data/)
