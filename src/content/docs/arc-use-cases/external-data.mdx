...
1. In the `resources` directory you can add the data (e.g. supplemental data files)
1. In the `protocols` directory you can add notes on how you retrieved the data and from where.
1. Add publication details to the study metadata
