...
import SwateOverview from '@images/Swate_a_overview2.png'
...
![Image highlighting important components of the swate in-table term search](@images/Swate_a_relatedtermsearch.png)
