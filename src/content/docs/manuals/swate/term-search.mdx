...
import SwateOverview from '@images/swate/swate-alpha-overview2.png'
...
![Image highlighting important components of the swate in-table term search](@images/swate/swate-alpha-relatedtermsearch.png)
...
import SwateRelationshipGraph from '@images/swate/swate-RelationshipGraph-Exp.jpg'
