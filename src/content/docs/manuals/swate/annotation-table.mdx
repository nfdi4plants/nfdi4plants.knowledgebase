...
:::tip
Consider reading about [Swate](./../implementation/Swate.html)
:::
...
![Image showing add new file option in Swate](@images/Swate_a_NewFile.PNG)
...
![Image showing Swate integration in ARCitect with focus on "add new annotation table"-button.](@images/Swate_a_Arcitect_newTable.png)
