...
![Image showing add new file option in Swate](@images/swate-alpha-NewFile.PNG)
...
![Image showing Swate integration in ARCitect with focus on "add new annotation table"-button.](@images/swate-alpha-Arcitect_newTable.png)
