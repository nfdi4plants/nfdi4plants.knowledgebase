...
![Alt text](@images/ArcCommander_access_1.png)

2. Select 'Settings' (1), then 'Access Tokens' (2):
![Alt text](@images/ArcCommander_access_2.png)
...
![Alt text](@images/ArcCommander_access_3.png)

4. Once created, you can copy the token:
![Alt text](@images/ArcCommander_access_4.png)
