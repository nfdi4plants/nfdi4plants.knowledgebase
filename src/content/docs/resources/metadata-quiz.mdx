...
description: Metadata recommendation quiz to help you find the metadata checklists and endpoint repositories best suited for your data.
authors:
  - stella-eggels
---

*The [metadata recommendation quiz](https://nfdi4plants.github.io/metadataquiz/) is meant to help you find the metadata checklists and endpoint repositories best suited for your data.*
