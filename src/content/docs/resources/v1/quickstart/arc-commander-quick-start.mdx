...
☑️ Please [install ARC Commander](./../ArcCommanderManual/index-setup.html)  
☑️ Find <a href="./tutorial_TheCommandLine.html" target="_blank">the command line    </a> on your system  
💡 Consider reading about [ARC](./../implementation/AnnotatedResearchContext.html) and the [ARC Commander](./../implementation/ArcCommander.html)  
💡 After concluding this quickstart, consider exploring the [ARC Commander manual](./../ArcCommanderManual/index.html) for a more detailed usage instruction.
...
![arc init](@images/arc-commander/arc-commander-init.png)
...
> 💡 After concluding this quickstart, you might want to explore the [ARC Commander manual](./../ArcCommanderManual/index.html) for a more detailed usage instruction.
