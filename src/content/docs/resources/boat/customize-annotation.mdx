...
As a next step, you should consider connecting your added key or terms to [ontologies](https://nfdi4plants.github.io/nfdi4plants.knowledgebase/fundamentals/ontologies/). Implementing ontologies enhances the value of your data by using predefined vocabulary with an unique ID.


To do this, just double click inside the text field and the built-in Term Search component will search in the [SwateDB](https://nfdi4plants.github.io/nfdi4plants.knowledgebase/fundamentals/ontology-service-landscape/#swatedb-and-swobup) for fitting ontologies. You might change the word a bit to get the best results. The search suggestions can be expanded to see the definitions and the ID of the ontology.
...
<Card icon="pen" title="BOAT">
  ...
  4. Redo this step with the Term `Einstein`. Here the best suggestion might be `einstein per square meter per second based unit`.
      ...
      You can find more info about the Term Search [here](https://nfdi4plants.github.io/nfdi4plants.knowledgebase/swate/term-search/).
      :::
