...
[DataPLAN](https://plan.nfdi4plants.org) is a [Data Management Plan](/nfdi4plants.knowledgebase/fundamentals/data-management-plan) generator, which can help users creating a plan for their [research data management](/nfdi4plants.knowledgebase/fundamentals/research-data-management). By using DataPLAN, standardized DMPs for Horizon Europe and Deutsche Forschungsgemeinschaft (DFG) can be generated in five minutes. The fast generation speed is enabled by a template design with integratable answers and single-page web application technology. 
