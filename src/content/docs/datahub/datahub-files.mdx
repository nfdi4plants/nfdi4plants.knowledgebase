---
title: Manages files in the DataHUB
...
1. From the [ARC panel](/nfdi4plants.knowledgebase/datahub/datahub-arc-panel), navigate to subdirectory of your ARC. 
...
1. From the [ARC panel](/nfdi4plants.knowledgebase/datahub/datahub-arc-panel), navigate to subdirectory of your ARC that you would like to download
