...
1. From the [ARC panel](/datahub/datahub-arc-panel), navigate to subdirectory of your ARC. 
...
1. From the [ARC panel](/datahub/datahub-arc-panel), navigate to subdirectory of your ARC that you would like to download
