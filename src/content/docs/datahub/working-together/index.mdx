...
1. You can [invite individual users](/nfdi4plants.knowledgebase/datahub/working-together/datahub-invite-collaborators) (1). This is helpful to share an ARC with selected colleagues.
2. To share an ARC with a group of users (e.g. a lab or consortium), you can [invite a group](/nfdi4plants.knowledgebase/datahub/working-together/datahub-invite-collaborators) (2).
...
- **Planner** &ndash; Has access to issues and project planning features (like boards and milestones) without access to the content of an ARC.
...
- Every [group and subgroup](/nfdi4plants.knowledgebase/datahub/working-together/datahub-groups) has an own namespace, respectively.
