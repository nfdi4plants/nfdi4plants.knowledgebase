...
_**Note:** All CQC pipelines are opt-in starting from July 10, 2024. If you used the DataHUB publication service before, head [here](/nfdi4plants.knowledgebase/arc-validation/validation-packages) to learn how to opt-in._
...
_practical guide: [passing cqc](/nfdi4plants.knowledgebase/datahub/data-publications/datahub-data-publications-cqc)_

Upon every commit to an ARC repository, PLANTdataHUB can perform automated quality control measures based on the committed changes. Form more information, have a look at [Continuous Quality Control (CQC) pipelines & ARC validation](/nfdi4plants.knowledgebase/arc-validation/cqc-pipelines).

## ARChigator: the ARC submission service

_practical guide: [Submitting ARCs with ARChigator](/nfdi4plants.knowledgebase/datahub/data-publications/datahub-data-publications-cqc)_ 
...
_practical guide: [Track your publication status](/nfdi4plants.knowledgebase/datahub/data-publications/datahub-data-publications-status)_ 
...
_practical guide: [Use your DOIs](/nfdi4plants.knowledgebase/datahub/data-publications/datahub-data-publications-dois)_ 