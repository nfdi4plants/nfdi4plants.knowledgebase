...
_practical guide: [passing cqc](/datahub/data-publications/datahub-data-publications-cqc)_

Upon every commit to an ARC repository, PLANTdataHUB can perform automated quality control measures based on the committed changes. Form more information, have a look at [Continuous Quality Control (CQC) pipelines & ARC validation](/arc-validation/cqc-pipelines).

## ARChigator: the ARC submission service

_practical guide: [Submitting ARCs with ARChigator](/datahub/data-publications/datahub-data-publications-cqc)_ 
...
_practical guide: [Track your publication status](/datahub/data-publications/datahub-data-publications-status)_ 
...
_practical guide: [Use your DOIs](/datahub/data-publications/datahub-data-publications-dois)_ 