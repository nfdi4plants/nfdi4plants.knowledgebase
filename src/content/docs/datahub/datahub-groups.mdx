...
- A "Group" is a group of users (then "members" of that group) with specific [permissions](/nfdi4plants.knowledgebase/datahub/datahub-working-together#roles-and-permissions).
