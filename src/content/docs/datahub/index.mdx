...
The DataPLANT [DataHUB](/datahub) is the platform where several strings of DataPLANT's 
[research data management](/fundamentals/research-data-management) run together. 
Here you can upload your research data as an annotated research context 
([ARC](/core-concepts/arc)), to document its changes (via [git](/fundamentals/version-control-git)-based 
version control) and [share](/fundamentals/data-sharing/) it with collaborators. [Metadata](/fundamentals/metadata)
...
In order to use the [DataHUB](/datahub) and other DataPLANT infrastructure and services, please [sign up](/datahub/datahub-account) with DataPLANT.  
