...
The DataPLANT [DataHUB][hp-DataHUB] is the platform where several strings of DataPLANT's 
...
version control) and [share][kb-DataSharing] it with collaborators. [Metadata][kb-Metadata] 
...
[data repositories][kb-PublicDataRepositories] or [data publications][kb-DataPublications].
