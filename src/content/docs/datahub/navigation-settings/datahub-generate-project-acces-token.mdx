...
![Alt text](@images/arc-commander/arc-commander-access-4.png)(/nfdi4plants.knowledgebase/datahub/navigation-settings/datahub-user-settings)
5. Finally, save the token somewhere 

</Steps>

:::note
Save you token somewhere because it is only displaced once.  
:::