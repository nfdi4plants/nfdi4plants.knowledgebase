...
1. navigate directly to the [projects panel](/datahub/datahub-projects) via the icon in the top-left (1)
...
From the side bar in the top-left corner (1) you can navigate to [projects](/datahub/datahub-projects) (2) or [groups](/datahub/datahub-groups) (3) panels.
...
2. navigate to the [user settings](/datahub/datahub-user-settings) (3), and
