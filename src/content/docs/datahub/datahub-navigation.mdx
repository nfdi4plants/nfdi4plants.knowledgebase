...
1. navigate directly to the [projects panel](/nfdi4plants.knowledgebase/datahub/datahub-projects) via the icon in the top-left (1)
...
From the side bar in the top-left corner (1) you can navigate to [projects](/nfdi4plants.knowledgebase/datahub/datahub-projects) (2) or [groups](/nfdi4plants.knowledgebase/datahub/datahub-groups) (3) panels.
...
2. navigate to the [user settings](/nfdi4plants.knowledgebase/datahub/datahub-user-settings) (3), and
