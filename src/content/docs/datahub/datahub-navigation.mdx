...
1. navigate directly to the [projects panel](/datahub/datahub-projects-panel) via the icon in the top-left (1)
...
From the side bar in the top-left corner (1) you can navigate to [projects](/datahub/datahub-projects-panel) (2) or [groups](/datahub/datahub-groups) (3) panels.
