...
### Using Common Workflow Language (CWL) to wrap your workflow
...
- add "Visualization" assay
- import [python script](./heatmap.py) into protocols
- import output heatmap file (TO-DO)
