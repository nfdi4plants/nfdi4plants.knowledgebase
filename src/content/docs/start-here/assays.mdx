...
![](@images/start-here/arc-prototypic-assay-identifyxxxxxx.svg)
...
<Card icon="pen" title="ARCitect">
    ...
    2. At the bottom of the right panel, click on the `+` right next to the `Metadata` sheet to add one sheet for each lab process.
...
<Card icon="pen" title="ARCitect">
    ...
    7. At the bottom of the table, type `6` in the text field and click `+` to add six rows to your table.
