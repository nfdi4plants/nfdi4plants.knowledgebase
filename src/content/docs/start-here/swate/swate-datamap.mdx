...
1. In the file tree, right-click the assay and select `Add Datamap`
2. Open the `isa.datamap.xlsx` file from the file tree
3. Open the "Data Annotator" tool and select the same file (`sugar_result.csv`) as before.
