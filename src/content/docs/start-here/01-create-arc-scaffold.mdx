...
So, where do i start? What is an ARC? How do i create one?
...
4. ARCitect creates the base ARC folder on your computer and opens it right away.
    ...
    :::note
    The `isa.investigation.xlsx` is not displayed inside ARCitect, but can be accessed by clicking on "AthalianaColdStressSugar" (in Violoas example).
    :::
