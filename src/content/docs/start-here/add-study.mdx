...
![](@images/start-here/newDPfigures/arc-prototypic-divide-conquer.svg)
...
![](@images/start-here/newDPfigures/arc-prototypic-identify-study.svg)
...
![](@images/start-here/newDPfigures/arc-prototypic-table-representation.svg)
...
![](@images/start-here/newDPfigures/arc-metadata-parameterization1.svg)

## Finding the metadata vocabulary and descriptors

![](@images/start-here/newDPfigures/arc-metadata-parameterization2.svg)

![](@images/start-here/newDPfigures/arc-metadata-parameterization3.svg)

## Adding a parameter to the study table 

![](@images/start-here/newDPfigures/arc-metadata-table-add-parameter.svg)

## Adding a characteristic to the study table 

![](@images/start-here/newDPfigures/arc-metadata-table-add-characteristic.svg)
