...
![](@images/start-here/newDPfigures/arc-prototypic-study-divide-conquer.svg)
...
![](@images/start-here/newDPfigures/arc-prototypic-study-identify.svg)
...
![](@images/start-here/newDPfigures/arc-prototypic-metadata-table-representation.svg)

## Referencing the protocol

![](@images/start-here/newDPfigures/arc-prototypic-study-protocolref.svg)
...
![](@images/start-here/newDPfigures/arc-prototypic-study-parameterization.svg)

## Finding the right metadata vocabulary

![](@images/start-here/newDPfigures/arc-prototypic-study-parameterization1.svg)

## Finding the metadata vocabulary and descriptors

![](@images/start-here/newDPfigures/arc-prototypic-study-parameterization2.svg)

![](@images/start-here/newDPfigures/arc-prototypic-study-parameterization3.svg)

## Adding a parameter to the study table 

![](@images/start-here/newDPfigures/arc-prototypic-metadata-table-add-parameter.svg)

## Adding a characteristic to the study table 

![](@images/start-here/newDPfigures/arc-prototypic-metadata-table-add-characteristic.svg)
