...
With **studies** you can describe materials and resources. 
...
{/* TODO import or show preview of protocol 

  import GrowthProtocol from '/public/Violas-PhD-Project/growth_protocol.md' 
...
<Card icon="pen" title="ARCitect">
  ...
  1. Select a cell in the `Protocol REF` column and click `Insert file names`.
      ...
      Is there a possibility to fill the complete column with the protocol reference? 
...
<Card icon="pen" title="ARCitect">
  ...
  1. From the dropdown menu select `Characteristic`. 
  ...
  1. Search for Arabidopsis thaliana, select a suitable hit and again fill the complete column with right-click on a cell and select `Fill Column`.
...
<Card icon="pen" title="ARCitect">
  <Steps>
    ...
    1. By clicking <btn> \>> </btn> or <btn> \<< </btn> in the column headers you can show or hide the ontology information.
        ...
        <ViolaSays>
          So if someone needs to lookup my species, they will find it in an online ontology database.
        </ViolaSays>
