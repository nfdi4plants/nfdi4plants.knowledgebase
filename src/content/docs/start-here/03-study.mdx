...
<ViolaSays>
And where do i put my experiment design? I grew my plants under different conditions, where can i describe this?
</ViolaSays>
...
<Card icon="pen" title="ARCitect">
  ...
  2. At the bottom of the right panel, click on the <btn>+</btn> right next to the `Metadata` sheet.
  3. This adds a new table sheet.
  4. Click on the **"Add Building Block"** button next to "Or start from scratch!".
...
<ViolaSays>
So what do i do with "growth temperature"? My experiment revolves around this specific parameter.
</ViolaSays>
