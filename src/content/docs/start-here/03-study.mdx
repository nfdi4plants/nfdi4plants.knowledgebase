...
1. Right-click on the `Protocols` folder and select `Import Files` from the context menu
    ...
    <ViolaSays>
    I saved my lab notes about the plant growth in growth_protocol.md
...
2. Click the magnifying glass to activate *Term* search
3. Search for Arabidopsis thaliana and select a suitable hit
...
- Parameter [Light intensity] of 200 microeinstein per square meter per second

## Add factors

- Factor [Temperature] of 25 vs 6 degree Celsius
...
- Move output column to "correct" place
- Delete column
