...
<Card icon="pen" title="ARCitect">
    ...
    2. Find your previous commit messages

        <ViolaSays>
            Great, so I even in five years I will know what I did in every step.
        </ViolaSays>
...
<Card icon="pen" title="ARCitect">
    ...
    3. In the `Add Remote` dialog, use the defaults for `Remote Name` ("origin"), `DataHUB Account` ("viola") and `URL` ("https://git.nfdi4plants.org/viola/AthalianaColdStressSugar.git")
