...
<Card icon="pen" title="ARCitect">
  ...
  7. Click the `Save` button to save your metadata. 
...
<Card icon="pen" title="ARCitect">
  ...
  8. Click the `Save` button to save your metadata. 
...
:::tip
When the `Save` button in the right corner is clicked, the `isa.xlsx` file is updated and saved. Therefore it is important to always press the button before changing the window.
:::
...
<Card icon="pen" title="ARCitect">
  <Steps>       
    ...
    1. In the *Building Blocks* widget, select *Factor*, search for `temperature day`, select the term with the ID `DPBO:0000007`.        
