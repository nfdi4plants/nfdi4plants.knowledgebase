...
![](@images/start-here/newDPfigures/arc-prototypic-identify-assay.svg)
...
![](@images/start-here/newDPfigures/arc-modular-assays1.svg)

## Separating different assay elements

![](@images/start-here/newDPfigures/arc-modular-assays2.svg)

## Parametric description of the lab process

### Sugar extraction

![](@images/start-here/newDPfigures/arc-labProcess-parameters1.svg)

### Sugar measurement

![](@images/start-here/newDPfigures/arc-labProcess-parameters2.svg)