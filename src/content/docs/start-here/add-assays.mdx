...
![](@images/start-here/newDPfigures/arc-prototypic-identifyTheAssay.svg)
...
![](@images/start-here/newDPfigures/arc-modularAssays.svg)

## Separating different assay elements

![](@images/start-here/newDPfigures/arc-modularAssays2.svg)
