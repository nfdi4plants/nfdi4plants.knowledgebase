...
![](@images/start-here/newDPfigures/arc-prototypic-assay-identify.svg)
...
![](@images/start-here/newDPfigures/arc-prototypic-assay-sugar.svg)
...
![](@images/start-here/newDPfigures/arc-prototypic-assay-modular1.svg)

## Separating different assay elements

![](@images/start-here/newDPfigures/arc-prototypic-assay-modular2.svg)

## Parametric description of the lab process

### Sugar extraction

![](@images/start-here/newDPfigures/arc-prototypic-assay-labprocess-parameters1.svg)

### Sugar measurement

![](@images/start-here/newDPfigures/arc-prototypic-assay-labprocess-parameters2.svg)



## Save time using standard methods and SOPs

![](@images/start-here/newDPfigures/arc-prototypic-assay-sop1.svg)
![](@images/start-here/newDPfigures/arc-prototypic-assay-sop2.svg)
![](@images/start-here/newDPfigures/arc-prototypic-assay-sop3.svg)
