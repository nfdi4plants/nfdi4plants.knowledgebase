...
:::note[Hidden]
This page is hidden on purpose, since it is only relevant for ARC reviewers.
:::
...
2. Communicate via response to the reviewer email list
3. Open the RFP request in https://archive.nfdi4plants.org
4. 
