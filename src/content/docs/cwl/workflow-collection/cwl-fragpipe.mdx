...
If you have the Fragpipe GUI installed, you can navigaet to the `workflows` folder and select the workflow you want to use. If you have a specific use case, you can create your own workflow following the 
tutorials on the [FragPipe website](https://fragpipe.nesvilab.org/). After you completed the workflow, you can save it and copy it from the FragPipe `workflows` into the `MyRun` folder in the `runs` directory. Alternatively, you can 
select to save it in a custom folder and directly save it to the `MyRun` folder.
