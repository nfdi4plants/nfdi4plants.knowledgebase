...
4. Use the `cwltool` to run the workflow:
    ...
    :::note
    This assumes that [cwltool](/nfdi4plants.knowledgebase/cwl/cwl-runner-installation) and python (with packages `plotly` and `kaleido`) are installed on your system.
    :::
