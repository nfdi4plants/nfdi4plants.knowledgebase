...
4. Use the `cwltool` to run the workflow:
    ...
    ```bash
    cwltool ../../workflows/heatmap run.yml
    ```
    
    :::note
    This assumes that python and [cwltool](/nfdi4plants.knowledgebase/cwl/cwl-runner-installation) are installed on your system.
    :::
