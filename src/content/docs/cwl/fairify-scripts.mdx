...
2. **Separate data analysis logic from data and environment**
...
3. Collect **information about dependencies**, such as external packages and tools
    ...
    - List all packages, libraries, and software tools used
...
4. **Uncouple processes from the execution environment**
