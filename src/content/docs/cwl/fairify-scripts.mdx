...
3. **Do not hard code input or output paths**
    - Reusability
...
- Input: path to a CSV file, a FASTA file.
- Output: path to a figure, a table, a processed file.
...
The following wraps your script in CWL as a `CommandLineTool`.

<Card icon="pen" title="Example">

<Tabs syncKey="pl">

1. Create a file named `workflow.cwl` and save it alongside the script.
