---
title: Integrating ARCs in your lab workflows
...
Here we explore how the ARC can help streamline data flows and project management in your lab.
The following steps are recommended to prepare your lab towards using ARCs.

:::tip
This guide can only stay at a very abstract level. Please [contact us for data stewardship](https://nfdi4plants.org/support/) to work out a suitable solution for your lab together.
:::
...
1. ### Create a DataHUB Group for your lab
    ...
    - You can make your group public so signed-in team members can easily find and request access to it. Making the group public does not make all ARCs public!
...
3. ### Create example ARCs
    ...
    - An example ARC helps understand the ARC concept and structure with your type of data and metadata.
    - Where can you find what information (protocols, datasets, results)?
    - Consider what information is required to represent the experiment from *source-to-data*.
    - [This guide](/nfdi4plants.knowledgebase/arc-use-cases/publication/) provides recommendations to create ARCs based on publications.
...
5. ### Package and share ARCs via your DataHUB group
    ...
    - Try to gradually move running projects into ARCs
    - 
...
4. ### Reuse or implement a naming convention

    - You can use your established system of identifiers in [ISA metadata](/nfdi4plants.knowledgebase/core-concepts/isa). There are designated places for any kind of laboratory items such as projects, samples, components, devices.
    - You can also keep naming your ARCs with the same way you are used to name your local projects or project folders
...
6. ### Design metadata templates
    ...
    - [Metadata templates](/nfdi4plants.knowledgebase/swate/swate-template-contribution) allow to unify how and what metadata is collected for sample annotation
...
6. ### Design metadata validation
    ...
    :::tip[Seek Data Steward support]
    This is really for advanced users and requires some coding. Ask for help by experienced data stewards.
    :::
...
7. ### Publish ARCs
    ...
    There are two major options: You can publish the current version of the ARC and receive a (https://www.doi.org/). 
