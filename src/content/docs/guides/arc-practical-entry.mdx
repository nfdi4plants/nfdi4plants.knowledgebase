...
:::tip
If you’re dealing with large files (e.g., raw sequencing data), you can initially store them anywhere. Just make sure they’re tracked with [Git LFS (Large File Storage)](/nfdi4plants.knowledgebase/git/git-lfs.mdx). This way, you can later move the LFS pointers into your ARC without dealing with the actual large files.
:::
