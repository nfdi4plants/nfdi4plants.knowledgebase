...
description: DataPLAN is a Data Management Plan (DMP) generator, which can help users creating a plan for their research data management.
authors: 
  - xiaoran-zhou
---

[DataPLAN][hp-DataPLAN] is a [Data Management Plan][kb-DataManagementPlan] generator, which can help users creating a plan for their [research data management](/fundamentals/research-data-management). By using DataPLAN, standardized DMPs for Horizon Europe and Deutsche Forschungsgemeinschaft (DFG) can be generated in five minutes. The fast generation speed is enabled by a template design with integratable answers and single-page web application technology. 
...
(/fundamentals/data-sharing/): ../fundamentals/DataSharing.html "Data Sharing"
...
(fundamentals/public-data-repositories): ../fundamentals/PublicDataRepositories.html "Repositories"
(/fundamentals/research-data-management): ../fundamentals/ResearchDataManagement.html "Research Data Management"
(/fundamentals/version-control-git): ../fundamentals/VersionControlGit.html "Version Control and Git"
...
(/datahub): <https://git.nfdi4plants.org> "DataPLANT DataHUB"
...
(https://plants.usegalaxy.eu/): <https://plants.usegalaxy.eu/> "Galaxy Plants"
