...
1. 
    <div>
        <DownloadLink client:load href="https://raw.githubusercontent.com/nfdi4plants/Swate/refs/heads/main/build/manifest.production.xml" filename="manifest.production.xml">
            Download the Swate Manifest File
        </DownloadLink>
    </div>
    :::tip
