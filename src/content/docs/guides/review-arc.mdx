...
For each study and assay in your ARC, check that:
    ...
    2. Within all annotation tables:
       ...
       - Column headers such as `Protocol REF` may not be manually renamed.
       ...
       - There are no missing columns.  E.g. is there important metadata in a protocol document that should be added to the annoation table?
