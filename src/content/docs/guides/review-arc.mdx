...
<Card icon="pen" title="DataHUB repository">
    ...
    5. Does your repository have a `LICENSE` file? This is required to allow re-use of your ARC. [Follow these instructions and recommendations](https://nfdi4plants.github.io/nfdi4plants.knowledgebase/datahub/arc-features/datahub-arc-license/#_top) to add an open license such as `MIT` or `Creative Commons` to your ARC. [IMPORTANT]
...
For each study and assay in your ARC, check that:
    ...
    2. Within all annotation tables:
       ...
       - Column types (e.g. characteristic, parameter, factor) are correct. See the [Annotation Principles](https://nfdi4plants.github.io/nfdi4plants.knowledgebase/core-concepts/isa-annotation-principles/#characteristics) for more details.
    ...
    7. Did you create or make the last editions in your ISA files in MS Excel rather than in one of the ARC tools? Make sure that:
       - Your your ISA-tables are tables in the MS Excel sense rather than ranges. Tables should include all lines and rows that are meant to contain Isa-formatted data.
