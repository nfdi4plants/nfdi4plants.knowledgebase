...
Option 1: [via ARC Commander](/arc-commander/access)
...
[Git LFS](/guides/arc-working-with-large-data-files) is basically the system in the back to simplify working with git and (ARCs containing) large data files.
