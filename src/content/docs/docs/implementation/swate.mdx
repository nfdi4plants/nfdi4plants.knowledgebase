...
![Building Blocks](@images/Swate_a_buildingblockcategories.PNG)
...
![Add Characteristic](@images/Swate_a_addCharacteristic.png)
...
![Templates](@images/swate_a_templates.png)
