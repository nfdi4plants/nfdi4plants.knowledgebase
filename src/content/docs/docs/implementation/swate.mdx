...
![Building Blocks](@images/swate/swate-alpha-buildingblockcategories.PNG)
...
![Add Characteristic](@images/swate/swate-alpha-add-Characteristic.png)
...
![Templates](@images/swate/swate-alpha-templates.png)
