...
![Building Blocks](@images/swate-alpha-buildingblockcategories.PNG)
...
![Add Characteristic](@images/swate-alpha-add-Characteristic.png)
...
![Templates](@images/swate-alpha-templates.png)
