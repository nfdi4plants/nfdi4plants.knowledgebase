...
![ARC](@images/ARC_BuildsOnStandards1.png)
...
The following gives an overview about DataPLANT tools and services supporting you in creating your own ARC. Follow the links below for details.
...
<CardGrid>
  <LinkCard
    ...
    href="/tutorials/arcCommander_QuickStart.html"
    description="<b>Tutorial:</b> <ul><li>How to initialize an ARC</li><li>How to package data with metadata</li></ul>"
  />
  <LinkCard
    title="Swate"
    href="https://github.com/nfdi4plants/Swate/"
    description="<b>Collect and structure:</b> <ul><li>Annotate experimental and computational workflows with ISA metadata schema</li><li>Easy use of ontologies and controlled vocabularies</li><li>Metadata templates for versatile data types</li></ul>"
  />
  <LinkCard
    title="ARC Commander"
    href="/manuals/ArcCommanderManual/index.html"
    description="<b>Collect, structure and share:</b> <ul><li>Add bibliographical metadata to your ARC</li><li>ARC version control and sharing via DataPLANT's DataHUB</li><li>Automated metadata referencing and version control as your ARC grows</li></ul>"
  />
  <LinkCard
    title="DataHUB"
    href="/manuals/ArcCommanderManual/index.html"
...
----------------|-----------|------------------
**[ARC Commander QuickStart][kb-QuickStart_arc]**   | Document | **Tutorial:** <ul><li>How to initialize an ARC</li><li>How to package data with metadata</li></ul>
...
**Converters** | Tool under construction | **Curate:** <ul><li>Harmonize and migrate between metadata schema</li> </ul>
