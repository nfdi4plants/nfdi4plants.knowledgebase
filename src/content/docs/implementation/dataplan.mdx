...
![The layout of DataPLAN](@images/dataplan_layout.png)
...
![Before deselect checkboxes](@images/dataplan_before_deselect.png)
*Figure 2: If all checkboxes of question 2 are selected, all counterparts in the DMP text will be kept.*

![After deselect checkboxes](@images/dataplan_after_deselect.png)
...
![User-defined template can also be directly used](@images/dataplan_user_defined.png)
...
![press Ctrl + S to save the file in html and then use it later on](@images/dataplan_save.png)
