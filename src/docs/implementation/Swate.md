...
Swate makes adding standardized metadata to your ISA Study and ISA Assay files <!-- link to ISA model --> easy by leveraging a simple use of ontologies <!-- link to ontology --> for your workflow annotation. 
