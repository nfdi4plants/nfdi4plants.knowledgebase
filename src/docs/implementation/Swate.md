...
Swate supports you in adding metadata to your ISA Study and ISA Assay files <!-- link to ISA model --> by making the usage of ontologies <!-- link to ontology --> for your workflow annotation as easy and intuitive as possible. 
...
If you could not find a fitting term for your data annotation, you can try to use Swate's Advanced Term Search. If you still could not find a fitting term, use free text input, as a non-ontology supported annotation is still better than no annotation. Feel free to <a href="javascript:location='mailto:\u0069\u006e\u0066\u006f\u0040\u006e\u0066\u0064\u0069\u0034\u0070\u006c\u0061\u006e\u0074\u0073\u002e\u006f\u0072\u0067';void 0">contact us</a> or open an issue in our [Helpdesk](<https://helpdesk.nfdi4plants.org>) if you want to request the addition of a term to our broker ontology. 
